...
use App\Http\Controllers\Management\ExpertReviewController;
use App\Http\Controllers\Management\PressRoomController;
...
//Route::get('/car-preview', function () {
//    return view('frontend.pages.car-preview');
//});
Route::get('/car-value', function () {
    return view('frontend.pages.carvalue');
});
Route::get('/articals', function () {
    return view('frontend.pages.articals');
});
Route::get('/pricing-specs', function () {
    return view('frontend.pages.pricing-specs');
});
//
//Route::get('/tips-advice', function () {
//    return view('frontend.pages.tips-advice');
//});
Route::get('/testdrivereview', function () {
    return view('frontend.pages.drive-review ');
});
Route::get('/pricetrends', function () {
    return view('frontend.pages.pricetrend ');
});
Route::get('/testdrivereview', function () {
    return view('frontend.pages.drive-rev ');
});
...
//});
Route::get('press-room',[App\Http\Controllers\Frontend\PagesController::class, 'pressRoom']);
Route::get('/press-room-detail/{id}', [App\Http\Controllers\Frontend\PagesController::class, 'pressRoomDetail']);

Route::get('/customer-reviews', [App\Http\Controllers\Frontend\PagesController::class, 'customerReview']);

Route::get('/find-dealer', [App\Http\Controllers\Frontend\PagesController::class, 'findDealer']);
...
Route::get('/by-the-number', function () {

    return view('frontend.pages.by-the-number');
});
Route::get('/car-listing', function () {

    return view('frontend.pages.car-listing');
});
Route::get('/car-offer', function () {

    return view('frontend.pages.car-offer');
});
Route::get('/car-deal', function () {

    return view('frontend.pages.car-deal');
});
Route::get('/single-news', function () {

    return view('frontend.pages.single-newsl');
});
...
//});
//Route::get('/vin2', function () {
//    return view('frontend.pages.vin2');
//});
...
Route::post('sell-car/details', [App\Http\Controllers\Frontend\PagesController::class, 'SellCarMoreDetail'])->name('sellCar.more.detail');
Route::get('sell-car-logs', [App\Http\Controllers\Frontend\PagesController::class, 'SellCarLogs'])->name('sellCar.logs');
Route::get('sell-car-logs/{id}', [App\Http\Controllers\Frontend\PagesController::class, 'SellCarLogsDetail'])->name('sellCarlogs.id');
...
Route::middleware(['auth'])
    ->group(function () {
        ...
        //single person chat
        Route::get('/single-chat ', [InboxController::class, 'singleChat'])->name('inbox.chat');
...
//Route::group(['middleware' => ['auth']], function() {
        ...
        //Press Release
        Route::resource('admin/press_release', PressRoomController::class);

        //Blog
        Route::resource('admin/blog', BlogController::class);
        
        //Expert Review
        Route::resource('expert-review', ExpertReviewController::class);
        ...
        Route::get('/tips-advice',[App\Http\Controllers\Frontend\PagesController::class,'tipsAdvice']);
        Route::get('/car-preview',[App\Http\Controllers\Frontend\PagesController::class,'carPreview']);
    });
