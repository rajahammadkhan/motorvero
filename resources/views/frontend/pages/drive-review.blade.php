                ...
                <div class="col-md-6">
                    <div class="row adivce-resources">
                        <div class="col-6">
                            ...
                            <h5 class="fw-bold pt-2">
                                <a href="#">The Best 7-Passenger SUVs of 2023</a>
                            </h5>
                            <p class="clr-light">by Chris Teague</p>
                            <p>There's never been a better time to shop for a 3-row SUV. These are the models you should be considering above all others.</p>
                        </div>
                        <div class="col-6">
                            <img src="https://eliteblue.net/motorvero/public/frontend/images/sell_car/image7.jpeg" alt="">
                            <h5 class="fw-bold pt-2">
                                <a href="#">Top Road Trip Hacks for 2023</a>
                            </h5>
                            <p class="clr-light">by Matt Smith</p>
                            <p>Planning a vacation? These handy hacks should help to ensure a successful road trip adventure.</p>
                        </div>
                        <div class="col-6">
                            <img src="https://eliteblue.net/motorvero/public/frontend/images/sell_car/image1.jpeg" alt="">
                            <h5 class="fw-bold pt-2">
                                <a href="#">All the Cars You Can Still Buy with a Manual Transmission</a>
                            </h5>
                            <p class="clr-light">by George Kennedy</p>
                            <p>The manual transmission might be down in numbers, but it’s not out. Look around the auto industry and you’ll find dozens of n... <a href="#">Read more</a></p>
                        </div>
                        <div class="col-6">
                            <img src="https://eliteblue.net/motorvero/public/frontend/images/sell_car/image6.jpeg" alt="">
                            <h5 class="fw-bold pt-2">
                                <a href="#">The Car Maintenance Schedule You Should Follow</a>
                            </h5>
                            <p class="clr-light">by Scott Sowers</p>
                            <p>Following a car's maintenance schedule is an important step in optimising not only its reliability but also its resale value.</p>
                        </div>
                    </div>
                </div>
            </div>
