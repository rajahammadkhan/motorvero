...
<section class="used-car-top-banner">
    <div class="container h-100">
        <div class="row align-items-center h-100">
            <div>
                <p class="heading">Shopping For A <span> Used Car?</span>
                </p>
...
<section class="mt-5">
    <div class="container-fluid px-md-5 px-sm-3 px-2">
        <div class="row  p-1  py-0 parent_dropdown">
            <div class="col-12">
                <button class="button-primary dropdown_menu  rounded-5 back-light p-2 px-3 fs-2 d-md-block mb-3 w-100">
            ...
            <div class="col-12">
                <div class="dropdown_items2 bg-md-auto bg-white rounded-3 p-md-0 p-3 mb-md-0 mb-3">
                    <div class="row px-md-3">
                        ...
                        @if(App\Helpers\DefaultLanguage::Cars(['condition'=>'Used']) != null)
                        @foreach(App\Helpers\DefaultLanguage::Cars(['condition'=>'Used', 'paginate'=>24]) as $cars)
...
<script>
    ...
    function checkMedia2(y) {
        if (y.matches) {
            $(".dropdown_menu2").click(function() {
                $(this).parents('.parent_dropdown').find(".dropdown_items2").slideToggle();
                $(this).parents('.parent_dropdown').find(".dropdown_menu2").toggleClass('active');
                // console.log($(this).parents('.parent_dropdown').find(".dropdown_menu"));
            });
        }
