...
@section('title')
    Pre Qualified - {{ config('app.dashboard') }}
@endsection
@section('content')
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title"> Pre Qualified</h4>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <table class="table" id="myTable">
                                ...
                                @foreach($data as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('pre-qualified.show',$row->id)}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{route('pre-qualified.destroy',$row->id)}}"
                                                                  method="post">
                                                                @csrf
                                                                @method('DELETE')
