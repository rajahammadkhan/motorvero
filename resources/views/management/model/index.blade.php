        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <a href="{{ route('model.create') }}" type="button" class="btn btn-primary"> Add Model
                            </a>
                        </div>
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                <thead>
                                <tr>
                                    <th class="col-lg-3">Model Name</th>
                                    <th class="col-lg-3">Maker Name</th>
                                        ...
                                        <td>
                                            @can('model-edit')
                                                <a class="btn bg-blue btn-circle"
                                                   href="{{ route('model.update', $model->id) }}">
                                            ...
                                            @can('model-delete')
                                                ...
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#exampleModalCenter{{ $model->id }}">
                                                    <i class="material-icons"> delete </i>
                                                </button>
                                            @endcan


                                            <div class="modal fade" id="exampleModalCenter{{ $model->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route('model.destroy', $model->id) }}"
                                                                  method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
