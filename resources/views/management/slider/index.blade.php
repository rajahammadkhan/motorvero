                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <a href="{{route('slider.create')}}" type="button" class="btn btn-primary"> Add Ads
                            </a>
                        </div>
                        ...
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th class="col-lg-3">Post Type</th>
                                ...
                                @foreach($slider as $row)
                                    <tr>
                                        <td>
                                            ...
                                            @endif
                                            <img style="" src="{{asset('images/media'.'/'.$image)}}" height="60px" width="60px">
                                        </td>
                                        <td>

                                            <label class="badge badge-danger">{{$row->type}}</label>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn bg-blue btn-circle" href="{{route('slider.show',$row->id)}}">
