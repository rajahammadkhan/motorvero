                                    ...
                                    <div class="row my-1">
                                        ...
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="status" id="Quiz-type" data-placeholder="Select">
                                                <option {{$slider->status == '1' ? 'selected' : ''}}   value= 1>Publish</option>
                                                <option {{$slider->status == '0' ? 'selected' : ''}}   value= 0>draft</option>
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="type" id="Quiz-type" data-placeholder="Select">
                                                <option {{$slider->type == 'ad' ? 'selected' : ''}}   value="ad">Ad</option>
                                                <option {{$slider->type == 'popup' ? 'selected' : ''}}   value="popup">popup</option>
...
{{--                                            <div class="form-line">--}}
{{--                                                <input value="{{$slider->orderby}}" type="number" id="erp_question_text" class="form-control" name="orderby" placeholder="orderby" required="">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
                                    ...
                                    <div class="row my-3">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input type="url" id="erp_question_text" value="{{$slider->url}}" class="form-control" name="url" placeholder="url" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
