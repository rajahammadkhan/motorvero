...
@section('title')
    Keyword Create - {{config('app.dashboard')}}
...
{{--                                    $bl = $_GET['type'];--}}
{{--                                @endphp--}}
                <form action="{{route('keyword.store')}}"  method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="card py-4">
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            <label for="email_address1"> <strong> Title name </strong></label>
                                            <div class="form-line">
