                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <a href="{{route('keyword.create')}}" type="button" class="btn btn-primary">Add
                            </a>
                        </div>
                                ...
                                @foreach($keyword as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn bg-blue btn-circle" href="{{route('keyword.show',$row->id)}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{route('keyword.destroy',$row->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
