...
@section('title')
    Press Release - {{config('app.dashboard')}}
@endsection
@section('content')
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            @can('press_release-create')
                                <a href="{{route('press_release.create')}}" type="button" class="btn btn-primary"> Add Press Release
                                </a>
                            @endcan
                        </div>
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                @if(count($pressRoom)>0)
                                    @foreach($pressRoom as $row)
                                        <tr>
                                            <td>
                                                @if(isset($row->media()->image) && $row->media()->image != null)
                                            ...
                                            @endif
                                            <td>
                                                @can('press_release-edit')
                                                    <a class="btn bg-blue btn-circle"
                                                       href="{{route('press_release.show',$row->id)}}">

                                                        <i class="material-icons" href="">edit</i>
                                                    </a>
                                                @endcan
                                                @can('press_release-delete')
                                                    <button type="button"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('press_release.destroy',$row->id)}}"
                                                                      method="post">
                                                                    @csrf
                                                                    @method('DELETE')
