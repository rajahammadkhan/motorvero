...
@section('title')
    Press Release Create - {{config('app.dashboard')}}
@endsection
@section('content')
    <style>
    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('press_release.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="category" id="Quiz-type"
                                                    data-placeholder="Select">
                                                <option selected>Select</option>
                                                <option value="1">Press Release
                                                </option>
                                                <option value="2">Press Coverage
                                                </option>
                                                <option value="3">Insights
                                                </option>
                                            </select>
                                        </div>
                                    </div>
