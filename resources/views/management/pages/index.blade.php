                    ...
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            @can('page-create')
                                ...
                                <a href="{{route('pages.create')}}" type="button" class="btn btn-primary"> Add Pages
                                </a>
                            @endcan
                        </div>
                            ...
                            <table class="table" id="myTable">
                                ...
                                @foreach($pages as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @can('page-edit')
                                                <a class="btn bg-blue btn-circle" href="{{route('pages.show',$row->id)}}">
