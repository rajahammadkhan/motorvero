...
@section('title')
    Pages Edit - {{config('app.dashboard')}}
@endsection
@section('content')
    <style>
    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('pages.update',$category->id)}}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class="col-12 my-3">
                                            <a target="_blank" href="{{url('page',$category->slug)}}" class="btn btn-primary float-right"> Preview   </a>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col">
                                            <div class="main_container m-3">
                                                <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                    ...
                                                    <input type="file" name="featured_image" accept=".jpg,.gif,.png,.webp"
...
{{--                                                           class="main_file w-100 h-100 form-control position-absolute  opacity-0" />--}}
{{--                                                    <div class="img-thumb">--}}
{{--                                                        <img class="main_img d-block w-100 h-100 position-absolute" src="{{asset('images/pages'.'/'.$category->featured_image)}}" alt="">--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
