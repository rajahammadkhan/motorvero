                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <a href="{{route('coupon.create')}}?type={{$bl}}" type="button" class="btn btn-primary">Add  {{base64_decode($bl)}}
                            </a>
                        </div>
                                        ...
                                        <td>
                                            @foreach($media as $image)
                                                ...
                                                @if($image[0]->reference_id == $row->id)
                                                    ...
                                                    <img style="" src="{{asset('images/media/'.$image[0]->image)}}" height="60px" width="60px">
                                                        @else
                                                    <img style="" src="{{asset('images/galleryimage.png')}}" height="60px" width="60px">
...
{{--                                    @if($image->reference_id == $row->id)--}}
{{--                                            @if($row->image!= null)--}}
{{--                                                @php $image = 'media/'.$image->image @endphp--}}
{{--                                            @else--}}
...
{{--                                                @endforeach--}}
                                        ...
                                        <td>
                                            ...
                                            <a class="btn bg-blue btn-circle" href="{{route('coupon.show',$row->id)}}?type={{$bl}}">
