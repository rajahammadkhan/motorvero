                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$testimonial->title}}" type="text"
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="status" id="Quiz-type"
                                                ...
                                                <option {{$testimonial->status == '1' ? 'selected' : ''}}   value=1>
                                                    Publish
                                                </option>
                                                <option {{$testimonial->status == '0' ? 'selected' : ''}}  value=0>
                                                    draft
                                                </option>
                                        ...
                                        <div class="col">
                                            <div class="main_container m-3">
                                                <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                    ...
                                                    <input type="file" name="user_profile" accept=".jpg,.gif,.png,.webp"
                                                    ...
                                                    <div class="img-thumb">
                                                        ...
                                                        @else
                                                            <img class="main_img d-block w-100 h-100 position-absolute"
                                                                 src="{{asset('images/media'.'/'.$testimonial->user_profile)}}"
                                                                 alt="">
                                                        @endif
                                                    </div>
                                                ...
                                                @else
                                                    <a class="btn mt-3 remove_lol fw-normal border-0 shadow-none"
                                                       data-id="{{$testimonial->id}}">Remove</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
