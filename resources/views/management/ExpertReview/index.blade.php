...
@section('title')
    Expert Review - {{config('app.dashboard')}}
@endsection
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            @can('blog-create')
                                <a href="{{route('expert-review.create')}}" type="button" class="btn btn-primary"> Add Expert Review
                                </a>
                            @endcan
                        </div>
                                            ...
                                            <td>
                                                @can('blog-edit')
                                                    <a class="btn bg-blue btn-circle"
                                                       href="{{route('expert-review.show',$row->id)}}">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('expert-review.destroy',$row->id)}}"
                                                                      method="post">
                                                                    @csrf
                                                                    @method('DELETE')
