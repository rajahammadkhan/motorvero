...
{{--                                                @endforeach--}}
                                    ...
                                    <div class="row my-3">
                                        <div class=" col-12">
                                            ...
                                            <input type="number" value="{{$subscription->no_of_pages ?? ''}}" name="no_of_pages" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class=" col-12">
                                            <label for="email_address1"><strong>Subscription Duration</strong></label>
                                            <input type="text" value="{{$subscription->subscription_duration ?? ''}}" name="subscription_duration" class="form-control">
                                        </div>
                                    </div>
