                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$blog->title}}" type="text" id="erp_question_text"
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$blog->seo()->meta_title ?? ''}}" type="text" id="erp_question_text"
                                    ...
                                    <div class="row my-4">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$blog->seo()->meta_keywords ?? ''}}" type="text"
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="type" id="Quiz-type"
                                                    data-placeholder="Select">
                                                <option value="" disabled>Select</option>
                                                <option {{$blog->type == "new" ? 'selected' : ''}}   value="new">
                                                    New
                                                </option>
                                                <option {{$blog->type == 'used' ? 'selected' : ''}}  value="used">Used
                                                </option>
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="category" id="category"
                                                    data-placeholder="Select">
                                                <option value="" disabled>Select</option>
                                                <option {{$blog->category == "blog" ? 'selected' : ''}}   value="blog">
                                                    Blog
                                                </option>
                                                <option {{$blog->category == 'research' ? 'selected' : ''}}  value="research">Research
                                                </option>
                                                <option {{$blog->category == 'article' ? 'selected' : ''}}  value="article">Article
                                                </option>
                                                <option {{$blog->category == 'advice' ? 'selected' : ''}}  value="advice">Advice
                                                </option>

                                            </select>
                                        </div>
                                    </div>
                                    <div class="row my-2" id="writtenBy" style="{{isset($blog->written_by)?'':'display: none'}}">
                                        <div class=" col-12">
                                            <label for="email_address1"><strong>Written By</strong></label>
                                            <input type="text" name="written_by" value="{{$blog->written_by}}">
                                        </div>
                                    </div>
                                    <div class="row my-1" id="showPages" style="{{($blog->category != 'article')?'display: none':''}}">
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2 " name="pages[]" multiple
                                                ...
                                                <option {{in_array('blog',$blog->page_name)? 'selected': ''}} value="blog">Blog
                                                </option>
                                                <option  {{in_array('research',$blog->page_name)? 'selected': ''}} value="research">Research
                                                </option>
                                                <option  {{in_array('sell_my_car',$blog->page_name)? 'selected': ''}} value="sell_my_car">Sell My Car
                                                </option>
                                                <option  {{in_array('tip_and_advice',$blog->page_name)? 'selected': ''}} value="tip_and_advice">Tip And Advice
                                                </option>
                                                <option  {{in_array('industry_insight',$blog->page_name)? 'selected': ''}} value="industry_insight">Industry Insight
                                                </option>
                                                <option  {{in_array('car_preview',$blog->page_name)? 'selected': ''}} value="car_preview">Car Preview
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="main_container m-3">
                                                <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                    ...
                                                    <div class="img-thumb">
                                                        @if($blog->media()->image == null)
                                                        @else
                                                            <img class="main_img d-block w-100 h-100 position-absolute"
                                                                 src="{{asset('images/media'.'/'.$blog->media()->image)}}"
                                                                 alt="">
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                @else
                                                    <a class="btn mt-3 remove_lol fw-normal border-0 shadow-none"
                                                       data-id="{{$blog->media()->id}}">Remove</a>
                                                @endif
